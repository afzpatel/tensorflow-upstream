...
install_ubuntu_16_python_pip_deps python3.12
cp -r /root//.local/lib/python3.12/site-packages/* /usr/local/lib/python3.12/dist-packages/.
rm -f /usr/bin/python3 && ln -s /usr/bin/python3.12 /usr/bin/python3
